...
class SecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final w = width ?? AppSizes.secondaryButtonWidth;
    final h = (height ?? AppSizes.secondaryButtonHeight) * (AppSize.isDesktop ? 1.25 : 1.0);
    final r = (radius ?? AppSizes.secondaryButtonCornerRadius);
    final textSize = AppSizes.secondaryButtonTextSize * (AppSize.isDesktop ? 1.25 : 1.0);
